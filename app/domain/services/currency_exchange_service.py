...
def get_exchange_rate(
    ...
    exchange_rate: ExchangeRate = currency_exchange_rate_repository.get_exchange_rate_by_codes(base_code, target_code)
...
def exchange(
    ...
    exchange_rate = get_exchange_rate(base_code, target_code, currency_exchange_rate_repository)
    if exchange_rate is None:
        return None
...
def reverse_exchange(
    ...
    exchange_rate = get_exchange_rate(target_code, base_code, currency_exchange_rate_rate_repository)
    if exchange_rate is None:
        return None
...
def cross_exchange(
    ...
    exchange_rate_1 = get_exchange_rate(base_code, base_currency, currency_exchange_rate_repository)
    exchange_rate_2 = get_exchange_rate(base_currency, target_code, currency_exchange_rate_repository)
    
    if exchange_rate_1 is None or exchange_rate_2 is None:
        return None
    
    return [exchange_rate_1, exchange_rate_2], exchange_rate_1.rate.value * amount * exchange_rate_2.rate.value
