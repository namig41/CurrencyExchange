...
from application.schema.router.exchange_rates import (
    ExchageRatesCreateSchema,
    ExchageRatesDetailSchema,
)
...
class ExchangeRatesRouter(BaseRouter):
    ...
    def handle_get(self, request: HTTPRequest) -> HTTPResponse:
        try:
            exchange_rate = ExchageRatesDetailSchema.parse_request(
                request,
    ...
    def handle_post(self, request: HTTPRequest) -> HTTPResponse:
        try:
            exchange_rate = ExchageRatesCreateSchema.parse_request(
                request,
